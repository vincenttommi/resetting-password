...
class  RegisterForm(UserCreationForm):
    ...
    password1 = forms.CharField(max_length=50, required=True,widget=forms.PasswordInput(attrs={'placeholders':'Password','class':'form-control','data-toggle':'password','id':'password',}))
